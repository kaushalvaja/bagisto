...
sed -i 's/export APACHE_RUN_USER=www-data/export APACHE_RUN_USER=bagisto/g' /etc/apache2/envvars
sed -i 's/export APACHE_RUN_GROUP=www-data/export APACHE_RUN_GROUP=bagisto/g' /etc/apache2/envvars
